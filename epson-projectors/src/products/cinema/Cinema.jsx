...
import products from "../../data/Cinemadata";
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-16 text-center animate-[fadeSlideUp_0.8s_ease-out]">
          <span className="inline-flex items-center gap-3 text-xs sm:text-sm font-semibold tracking-[0.4em] uppercase">
            ...
            <span className="bg-gradient-to-r from-red-500 via-red-200-300 to-red-500 bg-clip-text text-transparent">
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden rounded-[30px] border border-white/[0.07] bg-white/[0.035] backdrop-blur-xl shadow-[0_8px_30px_-14px_rgba(0,0,0,0.45)] transition-all duration-500 group-hover:shadow-[0_16px_45px_-14px_rgba(193,18,31,0.3)]">
                ...
                {/* Image stage */}
                <div className="relative flex h-64 items-center justify-center overflow-hidden bg-gradient-to-black from-white/[0.06] via-transparent to-transparent px-8 pt-10">
                  ...
                  {/* Reflection */}
                  <div className="absolute bottom-0 left-1/2 h-10 w-2/3 -translate-x-1/2 scale-y-[-1] bg-gradient-to-black from-white/10 to-transparent opacity-20 blur-sm" />
                </div>

                {/* Divider */}
                <div className="mx-6 h-px bg-gradient-to-red from-transparent via-white/[0.08] to-transparent transition-colors duration-300 group-hover:via-red-500/35" />
                ...
                <div className="p-6">
                  ...
                  <Link
                    to={`/products/home-cinema/${product.slug}`}
